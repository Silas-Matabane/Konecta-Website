...
function PartnerCard({ partner, index }) {
  ...
  return (
    ...
    >
      <div
        className={`font-heading font-bold text-sm ${partner.isMicrosoft ? "text-konecta-silver/85" : "text-konecta-white/80"} group-hover:text-konecta-orange transition-colors`}
      >
        {partner.name}
      </div>
