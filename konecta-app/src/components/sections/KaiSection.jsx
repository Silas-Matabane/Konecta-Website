...
const KAI_FEATURES = [
  {
    ...
    description: 'Konecta enables African enterprises and public sector organisations to deploy production-grade AI capabilities through strategic partnerships with global technology partners.',
  },
  {
    number: '02',
    title: 'Network Infrastructure & Data Environments',
    description: 'We provide the network infrastructure, data environments, and market integration required to capture and process large-scale data — along with enterprise AI infrastructure, cloud platforms, and cybersecurity architecture.',
  },
  {
    number: '03',
    title: 'Fully Integrated AI Ecosystem',
    description: 'Together, we deliver a fully integrated AI ecosystem — enabling organisations to deploy machine learning models, automate complex processes, and extract insight from vast data environments.',
  },
];
...
export default function KaiSection() {
  ...
  return (
    <section ref={ref} className="relative bg-konecta-black px-6 lg:px-14 py-section overflow-hidden" id="kai">
      {/* Ambient glow */}
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
        <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="section-eyebrow text-konecta-orange">AI Infrastructure & Factory</div>
      ...
      {/* Bottom CTA */}
      <div className={`mt-12 flex items-center justify-between pt-8 border-t border-[rgba(255,255,255,0.06)] transition-all duration-700 delay-500 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <p className="text-sm text-konecta-muted">Explore how our AI Infrastructure & Factory practice transforms enterprise operations.</p>
