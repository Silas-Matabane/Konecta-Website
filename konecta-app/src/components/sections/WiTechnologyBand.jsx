    ...
    <section ref={ref} className="relative bg-konecta-black px-6 lg:px-14 py-section overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="section-eyebrow text-konecta-orange justify-center">WiTechnology Initiative</div>
          ...
          <p className="text-base text-white/75 leading-relaxed mt-6 max-w-2xl mx-auto">
            The WiTechnology Summit brings together Africa&apos;s top telecoms operators, technology leaders, policymakers, and innovators to shape the continent&apos;s digital future.
          </p>
        </div>
        ...
        <div className={`flex gap-4 justify-center flex-wrap mt-12 transition-all duration-700 delay-400 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <Link to="https://witechnology.africa/" target="_blank" rel="noopener noreferrer" className="btn-primary">Learn About WiTechnology</Link>
