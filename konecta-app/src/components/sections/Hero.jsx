  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 px-6 lg:px-14 pt-32 pb-10">
        ...
        {/* CTAs */}
        <div className={`flex gap-4 mt-10 flex-wrap transition-all duration-1000 delay-500 ${heroInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <Link to="/platform" className="btn-primary">Explore Our Platform</Link>
      ...
      <div className="relative z-10 mt-auto px-6 lg:px-14 pb-12">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCounter end={12} suffix="+" label="African Markets" icon="🌍" />
          <StatCounter end={50} suffix="+" label="Enterprise Clients" icon="🏢" />
          <StatCounter end={3} label="Industry Platforms" icon="🎙️" />
          <StatCounter end={100} suffix="%" label="Women-Owned" icon="♀️" />
        </div>
      </div>
