  ...
  return (
    <section ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative px-6 lg:px-14 py-section z-10">
        ...
        >
          <h2
            className="font-heading font-extrabold leading-[1.05] tracking-tight text-konecta-white"
          ...
          <p className="text-lg text-white/80 mt-6 max-w-xl leading-relaxed">
            Whether you are planning a digital transformation programme,
            deploying large-scale connectivity infrastructure, or exploring
            artificial intelligence adoption, Konecta provides the strategic
            expertise and technology partnerships required to deliver results.
            Start the conversation with Konecta.
          </p>
        </div>

        <div
          className={`flex flex-wrap gap-4 mt-12 transition-all duration-700 delay-300 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <Link to="/wifi-platform#wfp-demo" className="btn-white">
            Book a Consultation
          </Link>
          <Link to="/events" className="btn-outline-white">
            Attend an Event
          </Link>
        </div>
      </div>
