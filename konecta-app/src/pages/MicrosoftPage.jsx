    ...
    <>
      <section ref={ref} className="px-6 lg:px-14 pt-40 pb-12">
        <div className={`transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="section-eyebrow text-konecta-silver">Microsoft Partner</div>
          ...
          <p className="text-base text-konecta-muted mt-6 max-w-2xl leading-relaxed">
            As an authorised Microsoft Partner, Konecta delivers the full Microsoft ecosystem to African enterprises â€” Azure, Microsoft 365, Copilot AI, and Dynamics 365.
          </p>
        </div>
      </section>
