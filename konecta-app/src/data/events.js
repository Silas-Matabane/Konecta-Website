export const events = [
  {
    ...
    extraDescription:
      "Konecta's experts anchor key sessions, positioning the company as the trusted voice at the intersection of technology and African business.",
    meta: [
      { icon: "📍", text: "Johannesburg, SA" },
      { icon: "👥", text: "200+ CIOs & IT Leaders" },
      { icon: "🎙️", text: "20+ Speakers" },
  ...
  {
    id: "municipal-indaba",
    slug: "municipal-indaba",
    name: "Municipal Indaba",
    ...
    extraDescription:
      "As a Level 1 B-BBEE company, Konecta bridges the gap between government procurement and world-class technology delivery.",
    stats: [
      { value: "150+", label: "Officials" },
      { value: "40+", label: "Municipalities" },
      { value: "Annual", label: "Frequency" },
    ],
